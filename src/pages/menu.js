const Menu = (() => {
  ...
  const menuRender = () => {
    ...
    para1.innerHTML = 'Mexican style pastor with chopped onion and coriander in the inside. Fried rice on the outside wrapped with tortilla, fried and topped with our famous Mexican salsa.';

    const para2 = document.getElementById('card-1');
    para2.innerHTML = 'Bolognese meat inside, Italian-seasoned rice on the outside, wrapped with homemade lasagna pasta and dressed with our 5 cheese grilled sauce. ';

    const para3 = document.getElementById('card-2');
    para3.innerHTML = 'Seafood and sausage inside, paella rice on the outside, wrapped with Iberic jam. All the flavor from Spain in a Japanese dish.';

    const para4 = document.getElementById('card-3');
    para4.innerHTML = 'Melon pearls and camembert cheese on the inside, rice on the outside, wrapped with prosciutto. The freshest roll we offer, perfect for hot days.';

    const para5 = document.getElementById('card-4');
    para5.innerHTML = 'Rib Eye inside with gouda cheese, rice on the outside, fried, and grilled with manchego cheese on top.';

    const para6 = document.getElementById('card-5');
    para6.innerHTML = 'A more conventional roll. Avocado and cucumber inside, rice outside, wrapped with grilled salmon, and topped with tobiko.';
  };
